...
.prop{background:var(--card);border:1px solid var(--linha);border-radius:2px;padding:20px 22px;box-shadow:var(--sombra)}
.prop-top{display:flex;justify-content:space-between;align-items:center;gap:10px;margin-bottom:6px}
